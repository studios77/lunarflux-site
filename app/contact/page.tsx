  ...
  return (
    <>
      ...
      <section className="container-page pb-24 pt-32 md:pt-36">
        ...
        {/* 상담 창구는 채팅 · 문의 폼 · 전화 셋입니다. 채팅 카드는
            SALESIQ.widgetCode 가 비면 통째로 빠집니다 — 붙지 않을 채팅을
            안내하지 않기 위해서입니다. 예전에 위젯을 지우면서 이 카드를
            남겨 두어 "화면 우측 하단의 채팅 버튼" 이라고 없는 버튼을
            가리킨 적이 있습니다. 운영 시간은 아래 전화 카드에 있습니다. */}
